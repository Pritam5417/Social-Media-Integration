    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(ProfileUser.this);
                builder_exitbutton.setTitle("Really Logout?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(ProfileUser.this, "Facebook Logged out successfully!", Toast.LENGTH_SHORT).show();
